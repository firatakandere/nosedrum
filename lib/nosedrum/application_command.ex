defmodule Nosedrum.ApplicationCommand do
  ...
  @doc """
  An optional callback that returns a map contains optional properties of slash application command.
  Used when registering the command with Discord. Only valid for slash commands.

  Read more in the official
  [Aplication Command documentation](https://discord.com/developers/docs/interactions/application-commands#application-command-object)
